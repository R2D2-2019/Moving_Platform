...
namespace r2d2::moving_platform {
    ...
    /**
     * Class motor_control_c is an abstract class that can be implemented for
     * all different kinds of motors This class exists so you can use the motor
     * even without knowing what motor you have been provided with.
     */
